...
class LiteNeXtDepthOptions:
     def __init__(self):
          self.parser = argparse.ArgumentParser(description="LiteNeXtDepth options")
          ...
          self.parser.add_argument("--lr",
                                   ...
                                   default=[0.0005, 5e-6, 35, 0.0001, 1e-5, 31])
